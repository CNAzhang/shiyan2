...
var progresssPlay=document.getElementsByClassName('progress-play')[0];
...
var musicData=[
    ['落春赋','张祖培25216950627'],
    ['Yesterday','张祖培25216950627'],
    ['江南烟雨色','张祖培25216950627'],
    ['Vision pt.II','张祖培25216950627'],
];
var musicId=0;
function initMusic(){
    ...
    audio.onloadedmetadata=function(){
        ...
        refreshRotate();
        totleTime.innerText=formaTime(audio.duration);
        audio.currentTime=0;
    };
}
initMusic();
...
function formaTime(value){
    ...
    if(hour>0){
        retutn `${hour.toString().padStart(2,'0')}:${minutes.toString().padStart(2,'0')}:${seconds.toString().padStart(2,'0')}`;
    }
...
function updateProgress(){
    ...
    progresssPlay.style.width=value*100+'%';
}
//yingyumos
var modeId=1;
